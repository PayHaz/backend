    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', to='app.category')),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AC', 'Активен'), ('AR', 'В архиве'), ('MD', 'На модерации'), ('CN', 'Отклонен')], default='MD', max_length=2)),
        ...
        migrations.AddField(
            model_name='user',
            name='city',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='app.city'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
